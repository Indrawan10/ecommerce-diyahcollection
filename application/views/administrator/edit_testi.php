		...
		<div class="card-body">
			...
			<form action="<?= base_url(); ?>administrator/testimonial/<?= $testi['id']; ?>" method="post" enctype="multipart/form-data">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="name" name="name" required autocomplete="off" value="<?= $testi['name']; ?>" />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" id="rating" name="rating" min="1" max="5" required value="<?= $testi['rating']; ?>" />
				</div>
