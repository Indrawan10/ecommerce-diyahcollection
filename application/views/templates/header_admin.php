  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url(); ?>administrator">
        ...
        <div class="sidebar-brand-text mx-3"><?= $this->session->userdata('admin') ? "ADMIN PANEL" : "OWNER PANEL" ?></div>
      </a>
      ...
      <?php if ($this->session->userdata('admin')) { ?>
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url(); ?>administrator/returpembelian">
            <i class="fas fa-fw fa-users"></i>
            <span>Retur Pembelian</span></a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url(); ?>administrator/returcustomer">
            <i class="fas fa-fw fa-users"></i>
            <span>Retur Customer</span></a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url(); ?>administrator/complain">
            <i class="fas fa-fw fa-comments"></i>
            <span>Complain</span></a>
        </li>
      <?php } ?>

      <?php if ($this->session->userdata('admin') || $this->session->userdata('owner')) { ?>
        ...
        <li class="nav-item">
          ...
          <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="<?= base_url('administrator/laporan_penjualan') ?>">Penjualan</a>
              <a class="collapse-item" href="<?= base_url('administrator/laporan_pembelian') ?>">Pembelian</a>
              <a class="collapse-item" href="<?= base_url('administrator/laporan_stokmasuk') ?>">Stok Masuk</a>
              <a class="collapse-item" href="<?= base_url('administrator/laporan_stokkeluar') ?>">Stok Keluar</a>
              <a class="collapse-item" href="<?= base_url('administrator/laporan_returcustomer') ?>">Retur Customer</a>
              <a class="collapse-item" href="<?= base_url('administrator/laporan_returpembelian') ?>">Retur Pembelian</a>
              <a class="collapse-item" href="<?= base_url('administrator/laporan_pendapatan') ?>">Pendapatan</a>
              <a class="collapse-item" href="<?= base_url('administrator/laporan_labarugi') ?>">Laba Rugi</a>
            </div>
          </div>
        </li>
      <?php } ?>
