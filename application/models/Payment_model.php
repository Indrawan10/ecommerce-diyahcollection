...
class Payment_model extends CI_Model
{
    ...
    public function getService($kurir)
    {
        ...
        if ($this->input->post('segment') == 'checkout') {
            $product = $this->db->get_where('products', ['id' => $this->input->post('id')])->row_array();
            $weight += (intval($product['weight']) * intval($this->input->post('qty')));
